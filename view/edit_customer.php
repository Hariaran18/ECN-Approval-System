<?php
    ...
    if($_SESSION["username"]) {
	    if(($_SESSION['access'] == "Admin") || ($_SESSION['access'] == "Controller")) {
            ...
            $qry2 = mysqli_fetch_assoc($qry);

            $name = $qry2['name'];
            $npi1 = $qry2['npi1'];
            $npi2 = $qry2['npi2'];
            $planner = $qry2['planner'];
            $sales = $qry2['sales'];
            $cs = $qry2['cs'];
            $purchasing = $qry2['purchasing'];
            $cam = $qry2['cam'];
            $bending = $qry2['bending'];
            $assembly = $qry2['assembly'];
            $cnc = $qry2['cnc'];
            $welding = $qry2['welding'];
            $finishing = $qry2['finishing'];
            $qa = $qry2['qa'];
    ...
    <html>
        ...
        <body>
            <div class="container">
                ...
                <br>
                <form class="form-group" action="../controller/edit_customer_controller.php" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr>
                            ...
                            <td><input type="text" class="form-control" id="cus_id" name="cus_id" value="<?php echo $cus_id; ?>" style="display:none;"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="npi1" name="npi1" style="height: 120px;" readonly><?php echo $npi1; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="npi2" name="npi2" style="height: 120px;" readonly><?php echo $npi2; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="planner" name="planner" style="height: 120px;" readonly><?php echo $planner; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="sales" name="sales" style="height: 120px;" readonly><?php echo $sales; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="cs" name="cs" style="height: 120px;" readonly><?php echo $cs; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="purchasing" name="purchasing" style="height: 120px;" readonly><?php echo $purchasing; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="cam" name="cam" style="height: 120px;" readonly><?php echo $cam; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="bending" name="bending" style="height: 120px;" readonly><?php echo $bending; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="assembly" name="assembly" style="height: 120px;" readonly><?php echo $assembly; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="cnc" name="cnc" style="height: 120px;" readonly><?php echo $cnc; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="welding" name="welding" style="height: 120px;" readonly><?php echo $welding; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="finishing" name="finishing" style="height: 120px;" readonly><?php echo $finishing; ?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" class="form-control" id="qa" name="qa" style="height: 120px;" readonly><?php echo $qa; ?></textarea>
