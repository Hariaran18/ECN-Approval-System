<?php
    ...
    if($_SESSION['username'] != '') {
        ...
        $query = "SELECT form_id, ecn_no, type, model FROM form_list WHERE status <> 10 AND {$department}_chk = 1 ORDER BY form_id DESC";
                        ...
                        <table class="table table-striped" style="width:100%" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>New</td>
                                    <td>
                                        <a href="approval.php?form_id=<?php echo $row['form_id'] ?>" class="btn btn-dark btn-sm">View</a>
                                    </td>
                                </tr>
                                <?php
                                }
