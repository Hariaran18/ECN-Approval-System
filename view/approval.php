<?php
    ...
    if($_SESSION['username'] != ""){
        ...
        // Show approval button if their box is ticked
        if ($row2[$dept1] == 1) {
            $show_btn = "block";
        } else {
            $show_btn = "none";
        ...
        // Show fields to edit if they are planner
        if (($row2[$dept1] == 1) && ($department == 'Planner')) {
            $editable = "required";
            $ast_sign = "<span style='color:red'>*</span>";
        } else {
            $editable = "readonly";
            $ast_sign = "";
        }
        ...
        // Show fields to edit if they are planner
        if (($row2[$dept1] == 1) && ($department == 'QA')) {
            $upload = "required";
            $ast_sign2 = "<span style='color:red'>*</span>";
        } else {
            $upload = "disabled";
            $ast_sign2 = "";
        }
...
<html>
    ...
    <form action="../controller/approve_form_controller.php" method="post" enctype="multipart/form-data">
        <header>
        <br><br>
            <div class="container">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="col" style="display:none;">
                            <label class="font-weight-bold">Form ID</label>
                            <input type="text" id="form_id" name="form_id" class="form-control" value="<?php echo $fid;?>" readonly>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <br>
                                <label class="font-weight-bold">ETD <?php echo $ast_sign; ?></label>
                                <input type="text" id="etd_no" name="etd_no" class="form-control" value="<?php echo $row2['etd_no'];?>" <?php echo $editable; ?>>
                            </div>
                            <div class="col">
                                <br>
                                <label class="font-weight-bold">Job No <?php echo $ast_sign; ?></label>
                                <input type="text" id="job_no" name="job_no" class="form-control" value="<?php echo $row2['job_no'];?>" <?php echo $editable; ?>>
                            </div>
                            <div class="col">
                                <br>
                                <label class="font-weight-bold">Implement Date <?php echo $ast_sign; ?></label>
                                <input type="date" id="implement_date" name="implement_date" class="form-control" value="<?php echo $row2['implement_date'];?>" <?php echo $editable; ?>>
                            </div>
                            <div class="col">
                                <br>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div>
                                    <label class="font-weight-bold">FA Report <?php echo $ast_sign2; ?></label>
                                    <input type="file" class="form-control" name="fa_report" id="fa_report" <?php echo $upload; ?>>
                                </div>                                
                            </div>
        ...
        <body>
            ...
            <div class="float-right" style="margin-right: 40px;">
                <input type="submit" class="btn btn-success btn-lg" value="Approve" style="display:<?php echo $show_btn; ?>"/>
            </div>
            <br><br>
        </body>
